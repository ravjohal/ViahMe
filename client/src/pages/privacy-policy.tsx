      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p>
              Viah.me ("we," "our," or "us") is committed to protecting your
              privacy. This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you use our wedding
              planning platform.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Vendors:</strong> When you express interest in or book a
                vendor's services
              </li>
              <li>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              browser settings. For more details, see our cookie consent options
              when you first visit our site.
            </p>
            <p>Types of cookies we use:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Essential:</strong> Required for basic site
                functionality
              </li>
              <li>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              active or as needed to provide services. Wedding-related data may
              be retained for up to 3 years after your wedding date unless you
