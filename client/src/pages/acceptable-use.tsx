      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p>
              This Acceptable Use Policy ("Policy") outlines the rules and guidelines for using Viah.me. 
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Collaborate with partners, family members, and wedding planners</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Upload or share content that is defamatory, obscene, or offensive</li>
              <li>Post content that promotes discrimination, harassment, or violence</li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Overwhelm the platform with automated requests (DoS attacks)</li>
              <li>Circumvent security measures or access restrictions</li>
              <li>Reverse engineer or decompile any part of the Service</li>
            </ul>

            <h3 className="text-lg font-medium">Spam and Unsolicited Communications</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>Send bulk unsolicited messages to users or vendors</li>
              <li>Use the messaging system for advertising unrelated services</li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Provide accurate and honest information about their services</li>
              ...
              <li>Not solicit couples to transact outside the platform to avoid fees</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Not contain personal identifying information of others without consent</li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              <a href="mailto:abuse@viah.me" className="text-orange-600 hover:underline">
                abuse@viah.me
              </a>
          ...
          <section className="space-y-4">
            ...
            <p>
              We reserve the right to take action at our discretion without prior notice for 
              severe violations.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              We may update this Policy at any time. Continued use of the Service after changes 
