...
const FEATURES = [
  {
    ...
    description:
      "Pre-configured templates for Sikh, Hindu, Muslim, Gujarati, South Indian, Mixed/Fusion, and General ceremonies with culturally-authentic event timelines.",
  },
  {
    icon: Users,
    title: "Culturally-Specialized Vendors",
    description:
      "Connect with vendors who understand your traditions—from Dhol players to Mehndi artists, Pandits to Qazis, and Garba instructors.",
  },
  {
    icon: Calendar,
    title: "Multi-Event Management",
    description:
      "Seamlessly manage 3-5 day celebrations with distinct vendor requirements and guest lists for each ceremony.",
  },
  {
    icon: DollarSign,
    title: "Budget by Ceremony",
    description:
      "Track expenses for each ceremony separately—Sangeet, Mehndi, Anand Karaj, Reception—with intelligent cost breakdowns. No spreadsheets needed.",
  },
  {
    icon: MessageSquare,
    title: "Direct Vendor Communication",
    description:
      "Message vendors, share documents, review contracts, and manage bookings—all in one place.",
  },
  {
    icon: Clock,
    title: "Real-Time Availability",
    description:
      "Check vendor availability instantly and book with confidence, preventing double-bookings across all your events.",
  },
];
...
const BENEFITS = [
  {
    ...
    description:
      "Unlike generic wedding apps, Viah.me understands the complexity of multi-day celebrations with unique cultural requirements.",
    icon: Heart,
  },
  {
    title: "Vendor Marketplace",
    description:
      "Access 36 specialized vendor categories including culturally-specific services rarely found on traditional platforms.",
    icon: Star,
  },
  {
    title: "Ditch the Spreadsheets",
    description:
      "Guest lists, budgets, expenses, vendor contracts, and RSVPs—all managed in one beautiful platform. No more juggling Google Sheets.",
    icon: CheckCircle,
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 dark:from-orange-950/20 dark:via-pink-950/20 dark:to-purple-950/20">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-24 lg:py-32 relative">
          <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
            <Badge
              variant="outline"
              className="text-xs sm:text-base px-3 sm:px-4 py-1.5 sm:py-2 border-orange-200 dark:border-orange-800"
            >
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 text-orange-600" />
              <span className="break-words">
                Your Multi-Day Wedding Command Center
              </span>
            </Badge>
            ...
            <p className="text-base sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-2">
              From Roka to Reception, manage every ceremony, vendor, and 400+
              guests in one place. Built for couples navigating the beautiful
              chaos of South Asian weddings.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-muted-foreground px-2">
              Generic wedding apps don't understand the unique complexity of
              South Asian celebrations. We do.
            </p>
          </div>
      ...
      <section className="py-12 sm:py-20 lg:py-32 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
            <Badge
              variant="outline"
              className="mb-4 text-xs sm:text-sm px-3 py-1 border-orange-200 dark:border-orange-800"
            >
            ...
            <p className="text-base sm:text-xl text-muted-foreground px-2">
              Unlike generic wedding apps, we understand that in South Asian
              culture, you invite the Sharma Family—not four separate people.
            </p>
          </div>
            ...
            <Card className="p-6 sm:p-8">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={i}
                    className="p-3 rounded-lg border bg-muted/50 flex items-center gap-3"
                  >
          ...
          <div className="mt-10 text-center">
            <Card className="inline-flex items-center gap-3 p-4 sm:p-6 bg-gradient-to-r from-orange-50 to-pink-50 dark:from-orange-950/30 dark:to-pink-950/30 border-2">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-muted-foreground">
                  Know exactly how many cards to order (
                  <span className="font-bold text-orange-600">120</span>) even
                  when your guest count is{" "}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Share a simple link with your parents. They can add their
                friends and family directly—no login, no app download, no tech
                support calls.
              </p>
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Every guest your parents add goes to a "Pending Approval" tab.
                Review before they hit your main list—no surprise +100 guests.
              </p>
              <Card className="p-4 bg-muted/50">
      ...
      <section className="py-12 sm:py-20 lg:py-32 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/20 dark:via-indigo-950/20 dark:to-purple-950/20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
            <Badge
              variant="outline"
              className="mb-4 text-xs sm:text-sm px-3 py-1 border-blue-300 dark:border-blue-800 bg-white/50 dark:bg-blue-950/50"
            >
            ...
            <p className="text-base sm:text-xl text-muted-foreground px-2">
              No apps to download, no accounts to create. Share a simple link
              and guests see everything they need.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6 border-2 border-blue-200 dark:border-blue-800">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Each guest gets a personalized link. One tap opens their
                  complete wedding itinerary - no passwords needed.
                </p>
              ...
              <Card className="p-6 border-2 border-indigo-200 dark:border-indigo-800">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Guests can download complete event schedules, venue details,
                  and directions - works offline too.
                </p>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              Perfect for aunties and uncles who just need the{" "}
      ...
      <section className="py-12 sm:py-20 lg:py-32 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-muted-foreground px-2">
              From the first planning steps to your last ceremony, manage every
              detail effortlessly.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Select from Sikh, Hindu, Muslim, Gujarati, South Indian, Mixed/Fusion, or General traditions. We'll auto-populate your ceremony timeline.",
              },
              {
                step: "2",
                title: "Connect with Vendors",
                description:
                  "Browse culturally-specialized vendors in your city. Check availability, compare prices, and book with confidence.",
              },
              {
                step: "3",
                title: "Manage Everything",
                description:
                  "Track budgets, manage guest lists, coordinate timelines, share playlists, and create your wedding website—all from your dashboard.",
              },
            ].map((item, index) => (
              <div
                key={index}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <Card className="max-w-4xl mx-auto p-6 sm:p-12 lg:p-16 text-center bg-gradient-to-br from-orange-50 to-pink-50 dark:from-orange-950/30 dark:to-pink-950/30 border-2">
            ...
            <p className="text-base sm:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
              Join couples who are planning unforgettable South Asian weddings
              with Viah.me. Start for free today—no credit card required.
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground text-center sm:text-left">
                  ...
                  <a href="https://sevaaiservices.com">SSJ 8-11 LLC</a>. All
                  rights reserved.
                </p>
              </div>
