      ...
      <main className="container mx-auto px-4 sm:px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p>
              By accessing or using Viah.me ("the Service"), you agree to be
          ...
          <section className="space-y-4">
            ...
            <p>
              Viah.me is a wedding planning platform designed specifically for
              South Asian weddings. Our Service provides tools for managing
              multi-day celebrations, connecting with vendors, tracking budgets,
              managing guest lists, and coordinating wedding-related activities.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              Viah.me connects couples with wedding vendors. We do not endorse,
              guarantee, or assume responsibility for any services provided by
              third-party vendors. Any agreements between users and vendors are
          ...
          <section className="space-y-4">
            ...
            <p>
              Certain features of the Service may require payment. All payments
              are processed securely through our payment partners. Refund
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              are owned by Viah.me and are protected by international copyright,
          ...
          <section className="space-y-4">
            ...
            <p>
              Viah.me shall not be liable for any indirect, incidental, special,
