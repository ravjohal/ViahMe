...
## Branding
The platform features a custom SVG logo (`attached_assets/viah-logo.svg`) with bride and groom illustrations:
- **Bride silhouette** with flowing dupatta in orange (#F28C28)
- **Groom's turban (pagri)** illustration in orange (#F28C28)
- **Typography**: "Viah" in deep maroon (#5D101D) with Times New Roman, ".me" in vibrant orange (#F28C28)
- **Format**: SVG for crisp rendering at all sizes with true transparency
