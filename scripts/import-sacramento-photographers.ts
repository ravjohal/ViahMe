...
async function main() {
  console.log("Starting Sacramento Photographer vendor import...");
  ...
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766035951211.txt');
    ...
    try {
      await sql`
        INSERT INTO vendors (
          ...
          ${vendor.name},
          'photographer',
          ARRAY['photographer', 'videographer', 'wedding_photography'],
          ${vendor.location},
          'Sacramento',
          '$$',
  ...
  console.log(`\nSuccessfully imported ${imported} new Sacramento Photographer vendors!`);
  process.exit(0);
}
