...
async function main() {
  console.log("Starting Photographer vendor import...");
  
  const sql = neon(process.env.DATABASE_URL!);
  
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766032979659.txt');
  ...
  console.log(`\nSuccessfully imported ${imported} Photographer vendors!`);
  process.exit(0);
}
