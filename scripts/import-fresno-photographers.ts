...
function parseHtmlListings(html: string): VendorData[] {
  ...
  // Use split approach for mobile-single-listing
...
async function main() {
  console.log("Starting Fresno Photographer vendor import...");
  ...
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766034898860.txt');
  ...
  console.log(`\nSuccessfully imported ${imported} new Fresno Photographer vendors!`);
  process.exit(0);
}
