...
async function main() {
  console.log("Starting Sacramento Entertainment vendor import...");
  ...
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766080830012.txt');
  ...
  console.log(`\nSuccessfully imported ${imported} new Sacramento Entertainment vendors!`);
  process.exit(0);
}
