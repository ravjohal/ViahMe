...
async function main() {
  console.log("Starting Fresno Venue vendor import...");
  ...
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766079482108.txt');
  ...
  console.log(`\nSuccessfully imported ${imported} new Fresno Venue vendors!`);
  process.exit(0);
}
