...
async function main() {
  console.log("Starting Fresno Mehndi Artist vendor import...");
  ...
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766036091584.txt');
  ...
  console.log(`\nSuccessfully imported ${imported} new Fresno Mehndi Artist vendors!`);
  process.exit(0);
}
