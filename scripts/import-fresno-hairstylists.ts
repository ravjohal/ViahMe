...
async function main() {
  console.log("Starting Fresno Hair Stylist vendor import...");
  ...
  const htmlPath = path.join(process.cwd(), 'attached_assets/Pasted--div-id-listing-div-xmlns-xlink-http-www-w3-org-1999-xl_1766035845461.txt');
  ...
  console.log(`\nSuccessfully imported ${imported} new Fresno Hair Stylist vendors!`);
  process.exit(0);
}
