...
export const DEFAULT_METRO_AREAS: Array<{
  ...
  { slug: "phoenix", value: "Phoenix", label: "Phoenix Metro", state: "AZ", country: "US", desiPopulation: "medium", hasVendorCoverage: true, displayOrder: 18 },
...
export const DEFAULT_METRO_CITIES: Array<{ metroSlug: string; cityName: string }> = [
  { metroSlug: "sf_bay_area", cityName: "San Jose" },
  { metroSlug: "sf_bay_area", cityName: "San Francisco" },
  { metroSlug: "sf_bay_area", cityName: "Oakland" },
  { metroSlug: "sf_bay_area", cityName: "Fremont" },
  { metroSlug: "sf_bay_area", cityName: "Sunnyvale" },
  { metroSlug: "sf_bay_area", cityName: "Mountain View" },
  { metroSlug: "sf_bay_area", cityName: "Palo Alto" },
  { metroSlug: "sf_bay_area", cityName: "Santa Clara" },
  { metroSlug: "sf_bay_area", cityName: "Hayward" },
  { metroSlug: "sf_bay_area", cityName: "Milpitas" },
  { metroSlug: "sf_bay_area", cityName: "Dublin" },
  { metroSlug: "sf_bay_area", cityName: "Livermore" },
  { metroSlug: "sf_bay_area", cityName: "San Ramon" },
  { metroSlug: "sf_bay_area", cityName: "Campbell" },
  { metroSlug: "sf_bay_area", cityName: "Tracy" },
  { metroSlug: "sf_bay_area", cityName: "Lathrop" },
  { metroSlug: "sf_bay_area", cityName: "Newark" },
  { metroSlug: "sf_bay_area", cityName: "Union City" },
  { metroSlug: "sf_bay_area", cityName: "Cupertino" },
  { metroSlug: "sf_bay_area", cityName: "Redwood City" },
  { metroSlug: "sf_bay_area", cityName: "San Mateo" },
  { metroSlug: "sf_bay_area", cityName: "Daly City" },
  { metroSlug: "sf_bay_area", cityName: "South San Francisco" },
  { metroSlug: "sf_bay_area", cityName: "Pleasanton" },
  { metroSlug: "sf_bay_area", cityName: "Walnut Creek" },
  { metroSlug: "sf_bay_area", cityName: "Concord" },
  { metroSlug: "sf_bay_area", cityName: "Antioch" },
  { metroSlug: "sf_bay_area", cityName: "San Leandro" },
  { metroSlug: "sf_bay_area", cityName: "Vallejo" },
  { metroSlug: "sf_bay_area", cityName: "Berkeley" },
  { metroSlug: "sf_bay_area", cityName: "Richmond" },
  { metroSlug: "sf_bay_area", cityName: "El Sobrante" },
  { metroSlug: "sf_bay_area", cityName: "Manteca" },
  { metroSlug: "sf_bay_area", cityName: "Stockton" },
  { metroSlug: "sf_bay_area", cityName: "Modesto" },
  { metroSlug: "sf_bay_area", cityName: "Northern California" },
  { metroSlug: "sacramento", cityName: "Sacramento" },
  { metroSlug: "sacramento", cityName: "Roseville" },
  { metroSlug: "sacramento", cityName: "Elk Grove" },
  { metroSlug: "sacramento", cityName: "Folsom" },
  { metroSlug: "sacramento", cityName: "Rancho Cordova" },
  { metroSlug: "sacramento", cityName: "Davis" },
  { metroSlug: "sacramento", cityName: "Woodland" },
  { metroSlug: "sacramento", cityName: "Yuba City" },
  { metroSlug: "sacramento", cityName: "Marysville" },
  { metroSlug: "sacramento", cityName: "Citrus Heights" },
  { metroSlug: "sacramento", cityName: "Rocklin" },
  { metroSlug: "sacramento", cityName: "Lincoln" },
  { metroSlug: "fresno", cityName: "Fresno" },
  { metroSlug: "fresno", cityName: "Clovis" },
  { metroSlug: "fresno", cityName: "Selma" },
  { metroSlug: "fresno", cityName: "Visalia" },
  { metroSlug: "fresno", cityName: "Hanford" },
  { metroSlug: "fresno", cityName: "Madera" },
  { metroSlug: "fresno", cityName: "Central Valley" },
  { metroSlug: "fresno", cityName: "Lodi" },
  { metroSlug: "fresno", cityName: "Merced" },
  { metroSlug: "fresno", cityName: "Turlock" },
  { metroSlug: "los_angeles", cityName: "Los Angeles" },
  { metroSlug: "los_angeles", cityName: "Anaheim" },
  { metroSlug: "los_angeles", cityName: "Buena Park" },
  { metroSlug: "los_angeles", cityName: "Artesia" },
  { metroSlug: "los_angeles", cityName: "Fullerton" },
  { metroSlug: "los_angeles", cityName: "Riverside" },
  { metroSlug: "los_angeles", cityName: "North Hollywood" },
  { metroSlug: "los_angeles", cityName: "Pacoima" },
  { metroSlug: "los_angeles", cityName: "Jurupa Valley" },
  { metroSlug: "los_angeles", cityName: "Walnut" },
  { metroSlug: "los_angeles", cityName: "Cerritos" },
  { metroSlug: "los_angeles", cityName: "Downey" },
  { metroSlug: "los_angeles", cityName: "Long Beach" },
  { metroSlug: "los_angeles", cityName: "Pasadena" },
  { metroSlug: "los_angeles", cityName: "Glendale" },
  { metroSlug: "los_angeles", cityName: "Burbank" },
  { metroSlug: "los_angeles", cityName: "Torrance" },
  { metroSlug: "los_angeles", cityName: "Irvine" },
  { metroSlug: "los_angeles", cityName: "Santa Ana" },
  { metroSlug: "los_angeles", cityName: "Ontario" },
  { metroSlug: "los_angeles", cityName: "Pomona" },
  { metroSlug: "los_angeles", cityName: "Corona" },
  { metroSlug: "los_angeles", cityName: "Moreno Valley" },
  { metroSlug: "los_angeles", cityName: "Fontana" },
  { metroSlug: "los_angeles", cityName: "Rancho Cucamonga" },
  { metroSlug: "los_angeles", cityName: "San Bernardino" },
  { metroSlug: "los_angeles", cityName: "Orange County" },
  { metroSlug: "los_angeles", cityName: "Southern California" },
  { metroSlug: "nyc", cityName: "New York" },
  { metroSlug: "nyc", cityName: "Manhattan" },
  { metroSlug: "nyc", cityName: "Brooklyn" },
  { metroSlug: "nyc", cityName: "Queens" },
  { metroSlug: "nyc", cityName: "Bronx" },
  { metroSlug: "nyc", cityName: "Staten Island" },
  { metroSlug: "nyc", cityName: "Jersey City" },
  { metroSlug: "nyc", cityName: "Edison" },
  { metroSlug: "nyc", cityName: "Perth Amboy" },
  { metroSlug: "nyc", cityName: "Hoboken" },
  { metroSlug: "nyc", cityName: "Newark" },
  { metroSlug: "nyc", cityName: "Morrisville" },
  { metroSlug: "nyc", cityName: "Long Island" },
  { metroSlug: "nyc", cityName: "Woodside" },
  { metroSlug: "nyc", cityName: "Jackson Heights" },
  { metroSlug: "nyc", cityName: "Floral Park" },
  { metroSlug: "chicago", cityName: "Chicago" },
  { metroSlug: "chicago", cityName: "Schaumburg" },
  { metroSlug: "chicago", cityName: "Naperville" },
  { metroSlug: "chicago", cityName: "Aurora" },
  { metroSlug: "chicago", cityName: "Elgin" },
  { metroSlug: "chicago", cityName: "Joliet" },
  { metroSlug: "chicago", cityName: "Bolingbrook" },
  { metroSlug: "seattle", cityName: "Seattle" },
  { metroSlug: "seattle", cityName: "Bellevue" },
  { metroSlug: "seattle", cityName: "Redmond" },
  { metroSlug: "seattle", cityName: "Kirkland" },
  { metroSlug: "seattle", cityName: "Renton" },
  { metroSlug: "seattle", cityName: "Kent" },
  { metroSlug: "seattle", cityName: "Tacoma" },
  { metroSlug: "seattle", cityName: "Everett" },
  { metroSlug: "seattle", cityName: "Bothell" },
  { metroSlug: "seattle", cityName: "Woodinville" },
  { metroSlug: "dallas", cityName: "Dallas" },
  { metroSlug: "dallas", cityName: "Fort Worth" },
  { metroSlug: "dallas", cityName: "Plano" },
  { metroSlug: "dallas", cityName: "Irving" },
  { metroSlug: "dallas", cityName: "Frisco" },
  { metroSlug: "dallas", cityName: "Arlington" },
  { metroSlug: "dallas", cityName: "Garland" },
  { metroSlug: "dallas", cityName: "Richardson" },
  { metroSlug: "dallas", cityName: "McKinney" },
  { metroSlug: "dallas", cityName: "Carrollton" },
  { metroSlug: "houston", cityName: "Houston" },
  { metroSlug: "houston", cityName: "Sugar Land" },
  { metroSlug: "houston", cityName: "Katy" },
  { metroSlug: "houston", cityName: "The Woodlands" },
  { metroSlug: "houston", cityName: "Pearland" },
  { metroSlug: "houston", cityName: "League City" },
  { metroSlug: "houston", cityName: "Missouri City" },
  { metroSlug: "houston", cityName: "Stafford" },
  { metroSlug: "boston", cityName: "Boston" },
  { metroSlug: "boston", cityName: "Cambridge" },
  { metroSlug: "boston", cityName: "Somerville" },
  { metroSlug: "boston", cityName: "Brookline" },
  { metroSlug: "boston", cityName: "Framingham" },
  { metroSlug: "boston", cityName: "Waltham" },
  { metroSlug: "boston", cityName: "Quincy" },
  { metroSlug: "dc", cityName: "Washington DC" },
  { metroSlug: "dc", cityName: "Arlington" },
  { metroSlug: "dc", cityName: "Alexandria" },
  { metroSlug: "dc", cityName: "Fairfax" },
  { metroSlug: "dc", cityName: "Reston" },
  { metroSlug: "dc", cityName: "Bethesda" },
  { metroSlug: "dc", cityName: "Silver Spring" },
  { metroSlug: "dc", cityName: "Rockville" },
  { metroSlug: "dc", cityName: "McLean" },
  { metroSlug: "atlanta", cityName: "Atlanta" },
  { metroSlug: "atlanta", cityName: "Decatur" },
  { metroSlug: "atlanta", cityName: "Marietta" },
  { metroSlug: "atlanta", cityName: "Roswell" },
  { metroSlug: "atlanta", cityName: "Alpharetta" },
  { metroSlug: "atlanta", cityName: "Johns Creek" },
  { metroSlug: "atlanta", cityName: "Lawrenceville" },
  { metroSlug: "atlanta", cityName: "Norcross" },
  { metroSlug: "philadelphia", cityName: "Philadelphia" },
  { metroSlug: "philadelphia", cityName: "Cherry Hill" },
  { metroSlug: "philadelphia", cityName: "King of Prussia" },
  { metroSlug: "philadelphia", cityName: "Plymouth Meeting" },
  { metroSlug: "philadelphia", cityName: "Conshohocken" },
  { metroSlug: "detroit", cityName: "Detroit" },
  { metroSlug: "detroit", cityName: "Dearborn" },
  { metroSlug: "detroit", cityName: "Troy" },
  { metroSlug: "detroit", cityName: "Novi" },
  { metroSlug: "detroit", cityName: "Farmington Hills" },
  { metroSlug: "detroit", cityName: "Canton" },
  { metroSlug: "detroit", cityName: "Ann Arbor" },
  { metroSlug: "toronto", cityName: "Toronto" },
  { metroSlug: "toronto", cityName: "Brampton" },
  { metroSlug: "toronto", cityName: "Mississauga" },
  { metroSlug: "toronto", cityName: "Hamilton" },
  { metroSlug: "toronto", cityName: "Markham" },
  { metroSlug: "toronto", cityName: "Vaughan" },
  { metroSlug: "toronto", cityName: "Oakville" },
  { metroSlug: "toronto", cityName: "Burlington" },
  { metroSlug: "toronto", cityName: "Milton" },
  { metroSlug: "toronto", cityName: "Ajax" },
  { metroSlug: "toronto", cityName: "Pickering" },
  { metroSlug: "toronto", cityName: "Whitby" },
  { metroSlug: "toronto", cityName: "Oshawa" },
  { metroSlug: "toronto", cityName: "Scarborough" },
  { metroSlug: "toronto", cityName: "Etobicoke" },
  { metroSlug: "toronto", cityName: "North York" },
  { metroSlug: "vancouver", cityName: "Vancouver" },
  { metroSlug: "vancouver", cityName: "Surrey" },
  { metroSlug: "vancouver", cityName: "Burnaby" },
  { metroSlug: "vancouver", cityName: "Langley" },
  { metroSlug: "vancouver", cityName: "Abbotsford" },
  { metroSlug: "vancouver", cityName: "Delta" },
  { metroSlug: "vancouver", cityName: "New Westminster" },
  { metroSlug: "vancouver", cityName: "Coquitlam" },
  { metroSlug: "vancouver", cityName: "Port Coquitlam" },
  { metroSlug: "vancouver", cityName: "Port Moody" },
  { metroSlug: "vancouver", cityName: "Maple Ridge" },
  { metroSlug: "vancouver", cityName: "Mission" },
  { metroSlug: "vancouver", cityName: "North Vancouver" },
  { metroSlug: "vancouver", cityName: "West Vancouver" },
  { metroSlug: "vancouver", cityName: "White Rock" },
  { metroSlug: "vancouver", cityName: "Chilliwack" },
  { metroSlug: "vancouver", cityName: "Kelowna" },
  { metroSlug: "vancouver", cityName: "Kamloops" },
  { metroSlug: "vancouver", cityName: "Vernon" },
  { metroSlug: "vancouver", cityName: "Pemberton" },
  { metroSlug: "vancouver", cityName: "Newton" },
  { metroSlug: "vancouver", cityName: "Lower Mainland" },
  { metroSlug: "miami", cityName: "Miami" },
  { metroSlug: "miami", cityName: "Fort Lauderdale" },
  { metroSlug: "miami", cityName: "Hollywood" },
  { metroSlug: "miami", cityName: "Coral Gables" },
  { metroSlug: "miami", cityName: "Hialeah" },
  { metroSlug: "phoenix", cityName: "Phoenix" },
  { metroSlug: "phoenix", cityName: "Scottsdale" },
  { metroSlug: "phoenix", cityName: "Tempe" },
  { metroSlug: "phoenix", cityName: "Mesa" },
  { metroSlug: "phoenix", cityName: "Chandler" },
  { metroSlug: "phoenix", cityName: "Gilbert" },
];
...
export const RITUAL_ROLE_TEMPLATES: Record<string, Array<{
  ...
  // Sikh ceremonies
  anand_karaj: [
    { roleName: "ardas_lead", roleDisplayName: "Ardas Lead", description: "Selecting the family member or Granthi to perform the opening and closing prayers", instructions: "Coordinate with the Granthi or designated family elder to lead the Ardas. Stand at the front near the Guru Granth Sahib. Lead the congregation in reciting the Ardas prayer at the opening and closing. Speak clearly and with reverence.", timing: "At the beginning and end of the ceremony", priority: "high" },
    { roleName: "palla_holder", roleDisplayName: "Palla Holder", description: "The family member (usually bride's father) who handovers the Palla (scarf) to the bride", instructions: "This is a deeply emotional role. Hand the palla (groom's scarf) to the bride, symbolizing the transfer of responsibility. Stand behind the bride during the Lavaan (4 circles around the Guru Granth Sahib).", timing: "During the Palla ceremony and Lavaan", priority: "high" },
    { roleName: "chaur_sahib_duty", roleDisplayName: "Chaur Sahib Duty", description: "Family members taking turns performing Chaur Sahib service during the ceremony", instructions: "Gently wave the Chaur Sahib (ceremonial whisk made of yak hair) over the Guru Granth Sahib as a sign of respect. Take turns with other assigned family members. This is a meditative, reverent duty.", timing: "Throughout the ceremony", priority: "high" },
    { roleName: "lavan_guides", roleDisplayName: "Lavan Guides", description: "Cousins/siblings who help the bride and groom move during the four rounds", instructions: "Walk alongside the couple during each of the four Lavaan (circumambulations). Help guide them around the Guru Granth Sahib. Assist with the bride's lehnga/outfit. Ensure they move at the right pace with the Shabads.", timing: "During the Lavaan ceremony", priority: "high" },
    { roleName: "rumala_sahib", roleDisplayName: "Rumala Sahib Attendant", description: "Manage the ceremonial cloth covering", instructions: "Handle the rumala (cloth covering) over the Guru Granth Sahib with respect. Adjust as needed during the ceremony.", timing: "Throughout the ceremony", priority: "medium" },
  ...
  maiyan: [
    { roleName: "maiyan_coordinator", roleDisplayName: "Maiyan Coordinator", description: "Ensuring the Vatna (turmeric paste), Peeri (stool), and Fulkari are ready for each side", instructions: "Prepare and organize all Maiyan items: mix the Vatna paste with turmeric, mustard oil, and sandalwood. Set up the Peeri (low stool) where the bride/groom will sit. Drape the Fulkari (phulkari embroidered cloth) over them. Coordinate timing with both families.", timing: "Before and during Maiyan ceremony", priority: "high" },
  ...
  jaggo: [
    { roleName: "jago_lead", roleDisplayName: "Jago Lead", description: "Managing the Jago pots, sticks, and leading the Boliyan (folk songs)", instructions: "Organize and distribute the decorated Jago pots and sticks. Lead the procession while singing traditional Boliyan (Punjabi folk songs). Keep the energy high and teach songs to participants who don't know them.", timing: "Throughout the Jaggo procession", priority: "high" },
  ...
  sangeet: [
    { roleName: "sangeet_performance_lead", roleDisplayName: "Sangeet Performance Lead", description: "The 'Stage Manager' for family dances and skits", instructions: "Act as the backstage stage manager. Coordinate all family dance performances and skits. Manage the performance order, cue performers, handle costume quick-changes, ensure props are ready. Keep the show running smoothly and on time.", timing: "Throughout the Sangeet", priority: "high" },
  ...
  milni: [
    { roleName: "milni_representatives", roleDisplayName: "Milni Representatives", description: "Assigning specific uncles (Tayaji, Mamaji) to greet their counterparts from the other side", instructions: "Identify and assign specific family members for each Milni pairing: Tayaji (paternal uncle), Mamaji (maternal uncle), Chacha (father's younger brother), etc. Brief each person on their counterpart from the other family. Ensure they know the sequence and have their garlands ready.", timing: "Before and during Milni ceremony", priority: "high" },
  ...
  // Wedding Morning ceremonies
  wedding_morning: [
    { roleName: "pagh_tyer", roleDisplayName: "Pagh Tyer (Turban)", description: "Assisting the groom and immediate family with professional turban tying", instructions: "Coordinate with the professional turban tier (pagri wala) or skilled family member. Assist the groom with his wedding turban (sehra pagh). Help immediate family members (father, brothers, uncles) who need turban assistance. Ensure turbans match the wedding colors and are tied comfortably for the long ceremony.", timing: "Morning of the wedding, before the baraat", priority: "high" },
  ],
  // Post-Ceremony
  doli: [
    { roleName: "doli_game_master", roleDisplayName: "Doli Game Master", description: "The sisters/cousins in charge of 'negotiating' for the groom's shoes or blocking the door", instructions: "Lead the bride's sisters and cousins in the traditional Joota Chupai (shoe-hiding) game. Negotiate playfully with the groom and his groomsmen for the ransom. May also organize 'blocking the door' games where the groom must pay to enter. Keep the atmosphere fun and lighthearted!", timing: "Post-ceremony, before the Doli departure", priority: "medium" },
    { roleName: "doli_coordinator", roleDisplayName: "Doli Coordinator", description: "Organize the bride's departure ceremony", instructions: "Coordinate the emotional farewell. Ensure the decorated car is ready. Gather family for final blessings. Have rice and flower petals ready for the send-off.", timing: "End of wedding ceremonies", priority: "high" },
  ],
  custom: [
...
// AI Chat Messages - persisted chat history for AI planner
...
export const stagedVendors = pgTable("staged_vendors", {
  ...
  resolvedMetro: text("resolved_metro"),
